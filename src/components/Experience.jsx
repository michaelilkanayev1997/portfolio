...
const Experience = () => {
  ...
  return (
    <div
      name="experience"
      className="bg-gradient-to-b from-gray-800 to-black w-full h-screen min-h-screen  pb-20 pt-12"
    >
      <div className="max-w-screen-lg pt-32 mx-auto p-4 flex flex-col justify-center w-full h-full text-white">
        ...
        <div className="w-full grid grid-cols-3 sm:grid-cols-6 gap-8 text-center py-8 px-6 sm:px-0 2xl:grid-cols-4">
          {techs.map(({ id, src, title, style }) => (
            <div
              key={id}
              className={`shadow-md hover:scale-105 duration-500 py-2 rounded-lg z-10 ${style}`}
            >
